...
use the mode line form doom emacs to provide more information while looking nicer
...
* look into
+ treemacs
+ [[https://github.com/LuigiPiucco/nerd-icons-corfu][GitHub - LuigiPiucco/nerd-icons-corfu: Icons for corfu via nerd-icons]]
+ projectile
+ ibuffer
+ deft
